...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7191159672:AAHqCrFLUDeVbOu2-z736vD-R9L6AnlsaAE")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6727550037 7162615398 5660025305 7400335416").split()):
        ADMINS.append(int(x))
except ValueError:
